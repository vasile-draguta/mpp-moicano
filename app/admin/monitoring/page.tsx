      ...
      <ContentScreen>
        ...
        <div className="bg-[#1E1E1E] shadow-md rounded-lg p-6 mb-6">
          ...
          <p className="text-gray-400 mb-4">
            This system automatically detects users who perform an unusually
            high number of actions in a short period of time. These users are
            flagged for monitoring and will appear in the monitored users list.
          </p>
